...
public class NumberPicker2 extends LinearLayout {
     ...
     * format().
     */
    private static class TwoDigitFormatter implements NumberPicker2.Formatter {
...
//                mInputText.clearFocus();
        ...
        mTextT = (TextView) findViewById(R.id.np__numberpicker_text);
...
//        mTextSize = (int) mInputText.getTextSize();
        mTextSize = (int) mTextT.getTextSize();
...
//        ColorStateList colors = mInputText.getTextColors();
        paint.setTypeface(mTextT.getTypeface());
        ColorStateList colors = mTextT.getTextColors();
...
//                mInputText.setVisibility(View.INVISIBLE);
                mTextT.setVisibility(View.INVISIBLE);
...
//        mInputText.setEnabled(enabled);
     ...
     * <p>
     * If the argument is less than the {@link ro.tudorluca.numberpicker.NumberPicker2#getMinValue()} and
     * {@link ro.tudorluca.numberpicker.NumberPicker2#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link ro.tudorluca.numberpicker.NumberPicker2#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link ro.tudorluca.numberpicker.NumberPicker2#getMinValue()} and
     * {@link ro.tudorluca.numberpicker.NumberPicker2#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link ro.tudorluca.numberpicker.NumberPicker2#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link ro.tudorluca.numberpicker.NumberPicker2#getMaxValue()} and
     * {@link ro.tudorluca.numberpicker.NumberPicker2#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link ro.tudorluca.numberpicker.NumberPicker2#getMaxValue()} value.
     * </p>
     * <p>
...
//        maxTextWidth += mInputText.getPaddingLeft() + mInputText.getPaddingRight();
        maxTextWidth += mTextT.getPaddingLeft() + mTextT.getPaddingRight();
     ...
     * wrap around the {@link ro.tudorluca.numberpicker.NumberPicker2#getMinValue()} and
     * {@link ro.tudorluca.numberpicker.NumberPicker2#getMaxValue()} values.
     * <p>
...
//            mInputText.setRawInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
            mTextT.setRawInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
        } else {
//            mInputText.setRawInputType(InputType.TYPE_CLASS_NUMBER);
            mTextT.setRawInputType(InputType.TYPE_CLASS_NUMBER);
        }
        updateInputTextView();
        initializeSelectorWheelIndices();
        tryComputeMaxWidth();
...
//            if (i != SELECTOR_MIDDLE_ITEM_INDEX || mInputText.getVisibility() != VISIBLE) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(NumberPicker2.class.getName());
...
//            return true;
//        }
        if (!TextUtils.isEmpty(text) && !text.equals(mTextT.getText().toString())) {
            mTextT.setText(text);
            return true;
        }
...
//                        postSetSelectionCommand(result.length(), val.length());
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            NumberPicker2.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            NumberPicker2.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                NumberPicker2.this.postDelayed(this,
...
//                            }
                            if (NumberPicker2.this.isEnabled() && !mTextT.isFocused()) {
                                return mTextT.requestFocus();
                            }
                        }
                        break;
...
//                            return mInputText.performAccessibilityAction(action, arguments);
                            return mTextT.performAccessibilityAction(action, arguments);
                        }
                    }
                }
                return false;
...
//                mInputText.onPopulateAccessibilityEvent(event);
                mTextT.onInitializeAccessibilityEvent(event);
                mTextT.onPopulateAccessibilityEvent(event);
...
//                    CharSequence text = mInputText.getText();
                    CharSequence text = mTextT.getText();
                    if (!TextUtils.isEmpty(text) &&
                            text.toString().toLowerCase().contains(searchedLowerCase)) {
...
//                    CharSequence contentDesc = mInputText.getText();
                    CharSequence contentDesc = mTextT.getText();
...
//            AccessibilityNodeInfo info = mInputText.createAccessibilityNodeInfo();
            AccessibilityNodeInfo info = mTextT.createAccessibilityNodeInfo();
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(NumberPicker2.class.getName());
            info.setPackageName(getContext().getPackageName());
